...
2. **Change `name` in `package.json`** away from `"imessage-dictionary"`.
...
**Reference:** See `imessage-dictionary-examples/nuxt.config.ts` for the full runtimeConfig block and `imessage-dictionary-examples/AGENT_ANALYTICS.md` for automation script details.
...
**Reference:** See `imessage-dictionary-examples/tests/` for example test files.
...
**Reference:** See `imessage-dictionary-examples/server/utils/auth.ts` and `imessage-dictionary-examples/app/composables/useAuth.ts`.
...
**Reference:** See `imessage-dictionary-examples/content/templates/blog/` and `imessage-dictionary-examples/app/pages/templates/blog/`.
...
1. Browse the components in `imessage-dictionary-examples/app/components/ui/` — includes `HeroSection`, `FeatureGrid`, `PricingTable`, `TestimonialCarousel`, `ContactForm`, `CTABanner`.
2. Browse layouts in `imessage-dictionary-examples/app/layouts/` — includes `blog.vue`, `dashboard.vue`, `landing.vue`.
...
**Reference:** See `imessage-dictionary-examples/app/components/ui/` for the full set.
...
**Reference:** See `imessage-dictionary-examples/app/components/AppFormCard.vue` and `imessage-dictionary-examples/app/composables/useFormHandler.ts`.
