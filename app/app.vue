      ...
      <header class="sticky top-0 z-50 border-b border-default bg-default/80 backdrop-blur-xl">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <NuxtLink to="/" class="flex items-center gap-2.5 group">
            ...
            <span class="font-display font-semibold text-lg hidden sm:block">iMessage Dictionary</span>
          </NuxtLink>
      ...
      <footer class="border-t border-default py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p class="text-center text-sm text-muted">
            iMessage Dictionary Template &middot; Nuxt UI 4 &middot; Cloudflare Workers &middot; {{ new Date().getFullYear() }}
          </p>
        </div>
      </footer>
    </div>
